...
namespace Shared.Sources.Editor
{
    ...
    /// draws a small indicator in the Project view for folders that are symlinks.<para/>
    ///
    /// https://github.com/karl-/unity-symlink-utility<para/>
    /// </summary>
    [InitializeOnLoad]
    public static class SymlinkUtility
    {
        ...
        [MenuItem("Assets/Create/Folder Symlink/Junction", false, 20)]
        ...
        [MenuItem("Assets/Create/Folder Symlink/Absolute Symlink", false, 21)]
        ...
        [MenuItem("Assets/Create/Folder Symlink/Relative Symlink", false, 22)]
        ...
        static void Symlink(SymlinkType linkType)
        {
            ...
            string pathToProject =
                Application.dataPath.Split(new string[1] { "/Assets" }, System.StringSplitOptions.None)[0];
