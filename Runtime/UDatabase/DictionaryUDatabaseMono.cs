...
{
    public class DictionaryUDatabaseMono<TKey, TValue, TKvp> : UDatabaseMono<TKey, TValue>
    ...
    public class DictionaryUDatabaseMono<TKey, TValue> : DictionaryUDatabaseMono<TKey, TValue, Kvp<TKey, TValue>>
    {
